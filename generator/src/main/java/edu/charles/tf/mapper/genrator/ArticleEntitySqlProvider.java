...
public class ArticleEntitySqlProvider {
    ...
    public String updateByPrimaryKeySelective(ArticleEntity record) {
        ...
        if (record.getAuthor() != null) {
            sql.SET("author_id = #{author,jdbcType=BIGINT,typeHandler=edu.charles.tf.base.mapper.handler.ForeignKeyObjectTypeHandler}");
        }
        
        if (record.getTags() != null) {
            sql.SET("tag_id = #{tags,jdbcType=BIGINT,typeHandler=edu.charles.tf.base.mapper.handler.ForeignKeyObjectTypeHandler}");
        }
