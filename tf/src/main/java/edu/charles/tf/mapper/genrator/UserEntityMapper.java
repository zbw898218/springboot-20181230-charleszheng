...
public interface UserEntityMapper {
    ...
    int updateByExampleSelective(@Param("record") UserEntityWithBLOBs record,
            @Param("example") UserEntityExample example);
    ...
    int updateByExampleWithBLOBs(@Param("record") UserEntityWithBLOBs record,
            @Param("example") UserEntityExample example);
